...
public class CustomAdapterEVList extends RecyclerView.Adapter<CustomAdapterEVList.ViewHolder>
{
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.txtVwRPID.setText("RPID: "+rehab.getRehabPlanID());

        if (rehab.getEvLink().equalsIgnoreCase("null")) {
            holder.txtVwEL.setText("Exercise Video: NO");
        } else {
            holder.txtVwEL.setText("Exercise Video: YES");
        }

        if (rehab.getEvFeedback().equalsIgnoreCase("null")) {
            holder.txtVwRPfed.setText("Feedback: NO");
        } else {
            holder.txtVwRPfed.setText("Feedback: YES");
        }
    }
