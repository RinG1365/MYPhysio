...
public class MainMenu extends AppCompatActivity
    ...
    String txtUsername;
    String strURL = "http://192.168.0.159:8888/myPhysioWebService/dashboardService.php";
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        {
            intent = new Intent(this,MYPhysio.class);
    ...
    public void fnGoToEV(View view)
    {
        Intent intent = null;
        intent = new Intent(this, ExerciseVideo.class);
        startActivity(intent);
    ...
    public void fnGoToApp(View view)
    {
        Intent intent = null;
        intent = new Intent(this, AppointmentActivity.class);
        startActivity(intent);
