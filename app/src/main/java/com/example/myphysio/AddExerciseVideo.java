...
public class AddExerciseVideo extends AppCompatActivity implements View.OnClickListener{
    ...
    String strURL = "http://192.168.0.159:8888/myPhysioWebService/rehabService.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtTxtUEVDate.setOnClickListener(this);
        ...
        if(v == edtTxtUEVDate)
        {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(this,
                    new DatePickerDialog.OnDateSetListener() {
                        ...
                        {
                            edtTxtUEVDate.setText(year + "-" + (month+1)+"-"+dayOfMonth);
                        }
                    },mYear,mMonth,mDay);
